...
Os pets são ordenados do mais recente para o mais antigo. A resposta inclui um objeto `pagination` com metadados (total de itens, total de páginas, etc.).# patacerta
